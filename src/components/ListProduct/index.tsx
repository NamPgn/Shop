...
const ListProduct = () => {
  ...
  const list = [
    { id: 1, name: "Product 1", category: "All" },
    { id: 1, name: "Product 2", category: "Women’s" },
    { id: 1, name: "Product 3", category: "Men’s" },
    { id: 1, name: "Product 4", category: "Kid’s" },
    { id: 1, name: "Product 5", category: "Accessories" },
    { id: 1, name: "Product 6", category: "Cosmetics" },
  ];
        ...
        <div className="flex items-center">
          ...
          <div className="options w-6/12">
            <ul className="flex gap-[25px] justify-center">
              ...
              <li onClick={() => handleCategoryClick("Accessories")}>
                Accessories
              </li>
              <li onClick={() => handleCategoryClick("Cosmetics")}>
                Cosmetics
              </li>
            </ul>
          </div>
